...
bot.start(async ctx => {
    ...
    await ctx.replyWithPhoto({url: "https://thumbs.dreamstime.com/b/mascot-icon-illustration-brazilian-jiu-jitsu-gracie-jujutsu-master-arms-folded-viewed-font-isolated-183890261.jpg"})

    await ctx.replyWithLocation(-3.75234496847403, -38.5264936538391)
    await ctx.replyWithVideo("https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4")
})
